...
#
#     PHX_SERVER=true bin/stashix start
#
# Alternatively, you can use `mix phx.gen.release` to generate a `bin/server`
# script that automatically sets the env var above.
if System.get_env("PHX_SERVER") || System.get_env("MIX_ENV") == "prod" do
...
if config_env() == :prod do
  ...
  config :stashix, :dns_cluster_query, System.get_env("DNS_CLUSTER_QUERY")
