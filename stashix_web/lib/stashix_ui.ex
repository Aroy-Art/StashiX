defmodule StashixUi do
  ...
  ### Server-Client Communication
      ...
      def handle_event("open_dialog", _params, socket) do
        socket = StashixUi.LiveView.send_command(socket, "user-dialog", "open")
        {:noreply, socket}
      end
  ...
  defmacro __using__(_) do
    quote do
      import StashixUi.Accordion
      import StashixUi.Alert
      import StashixUi.AlertDialog
      import StashixUi.Avatar
      import StashixUi.Badge
      import StashixUi.Breadcrumb
      import StashixUi.Button
      import StashixUi.Card
      import StashixUi.Chart
      import StashixUi.Checkbox
      import StashixUi.Collapsible
      import StashixUi.Dialog
      import StashixUi.DropdownMenu
      import StashixUi.Form
      import StashixUi.Helpers
      import StashixUi.HoverCard
      import StashixUi.Icon
      import StashixUi.Input
      import StashixUi.Label
      import StashixUi.Menu
      import StashixUi.Pagination
      import StashixUi.Popover
      import StashixUi.Progress
      import StashixUi.RadioGroup
      import StashixUi.ScrollArea
      import StashixUi.Select
      import StashixUi.Separator
      import StashixUi.Sheet
      import StashixUi.Sidebar
      import StashixUi.Skeleton
      import StashixUi.Slider
      import StashixUi.Switch
      import StashixUi.Table
      import StashixUi.Tabs
      import StashixUi.Textarea
      import StashixUi.Toast
      import StashixUi.Toggle
      import StashixUi.ToggleGroup
      import StashixUi.Tooltip
    end
  end
end
